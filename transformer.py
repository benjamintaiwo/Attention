...
from preprocess import TokenList, pad_to_longest
...
class EncoderLayer():
# =============================================================================
# Encode transformer inputs. Initiates 2 sub layers:
    # Multiheaded self attention layer and 
    # feedforward layer        
# =============================================================================
...
class DecoderLayer():
# =============================================================================
# Decoder transformer layer. initiates 3 sublayers:
     # feedforward layer
     # Multiheaded self attention layer and 
     # Multiheaded encoder -decoder attention
# =============================================================================
